...
def scan_area(north, south, west, east):
    ...
    work_queue = boto3.resource('sqs', region_name='us-west-2', aws_access_key_id=ACCESS_KEY, aws_secret_access_key=SECRET_KEY).get_queue_by_name(QueueName=SQS_QUEUE_NAME)
