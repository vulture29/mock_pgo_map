...
map_manager.map_items = [{"latitude": 40.7636057395893, "expire": 1483153329000.0, "longitude": -73.9929199225878, "pokemon_id": 452}];
...
window.setInterval(refresh_pokemon_data, 100000);

window.setInterval(refresh_pokemon_layer, 100000);
